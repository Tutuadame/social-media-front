...
import {getProfile, updateIntroduction} from "../api/profile/profileAPI.ts";
...
export const SocialProfilePage = () => {
        ...
        const onSubmit = async () => {
            if(!intro) return;
            const introduction = await updateIntroduction(currentId, intro).then(result => result.data.introduction);
            setEdit(false);
        ...
        return <div className="w-full h-full">
            ...
            <div className="max-h-[60vh] flex flex-col w-10/12 p-5 m-auto gap-10 overflow-auto">
                ...
                <div className={editableContainerStyle}>
                    ...
                    { edit ?
                        <>
                    	<textarea className="text-slate-900 rounded-xl p-3 text-xl w-full h-[15vh] bg-slate-400 font-normal focus:outline-none" value={intro} onInput={handleChange}>
